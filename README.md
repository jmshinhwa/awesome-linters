...
- [Kubernetes Removed API Lint](https://getreadystack.com/tools/k8s-removed-api-lint) - 15 checks for the apiVersions kubectl no longer serves, on the manifest open in your editor.
